...
# /boot
# /nix
# /nix-path-registration <-- a file probably not needed
...
pkgs.stdenv.mkDerivation {
  ...
  buildCommand =
    ''
      ...
      # TODO: this is where it actually happens
      faketime -f "1970-01-01 00:00:01" fakeroot mkfs.btrfs -L ${volumeLabel} -U ${uuid} $img
      faketime -f "1970-01-01 00:00:01" fakeroot btrfs subvolume create $img
